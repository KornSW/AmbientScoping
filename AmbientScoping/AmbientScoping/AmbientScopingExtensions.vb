...
Public Module AmbientActions
  ...
  Public Sub DropInto(Of T)(objectToSupply As T, closure As Action)
  ...
  ''' </summary>
  <Extension(), EditorBrowsable(EditorBrowsableState.Always)>
  Public Sub DropInto(itemKey As Object, objectToSupply As Object, closure As Action)
  ...
  ''' </summary>
  <Extension(), EditorBrowsable(EditorBrowsableState.Always)>
  Public Sub SupplyAmbient(Of T)(objectToSupply As T, scope As AmbientScope)
  ...
  ''' </summary>
  <Extension(), EditorBrowsable(EditorBrowsableState.Always)>
  Public Sub SupplyAmbient(itemKey As Object, objectToSupply As Object, scope As AmbientScope)
  ...
  ''' </summary>
  <Extension(), EditorBrowsable(EditorBrowsableState.Always)>
  Public Sub SupplyAmbient(Of T)(onDemandFactory As Func(Of T), scope As AmbientScope)
  ...
  <Extension(), EditorBrowsable(EditorBrowsableState.Always)>
  Public Sub UnsupplyAmbient(Of T)(scope As AmbientScope)


  End Sub

  <Extension(), EditorBrowsable(EditorBrowsableState.Always)>
  Public Sub UnsupplyAmbient(itemKey As Object, scope As AmbientScope)
